...
|layers   | 2     | 2     | 2   | 2     | --- |
|filters  | 128   | 512   | 512 | 256   | --- |
|gaussians| 50    | 50    | 50  | 100   | --- |
|z_dim    | 512   | 256   | 256 | 128   | --- |
|dropout  | 0.3   | 0.1   | 0.0 | 0.2   | --- |
|optim    | Expo  | Expo  | Expo | Expo | --- |
|Super    | 1.012 | 2.379 | ---  | 50.8 | --- |
|Pretrain | 0.745 | 1.533 | 0.723| 43.4 | --- |
|SOTA     | Yes   | Yes   | No   | Yes  | --- |
<br />
...
|cutoff   | 5.0   | 8.0   | 8.0 | 8.0   | ESOL  | ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|layers   | 2     | 2     | 2   | 2     | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|filters  | 128   | 512   | 512 | 256   | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|gaussians| 50    | 50    | 50  | 100   | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|z_dim    | 512   | 256   | 256 | 128   | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|dropout  | 0.3   | 0.1   | 0.0 | 0.2   | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|optim    | Expo  | Expo  | Expo | Expo | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|Super    | 1.012 | 2.379 | ---  | 50.8 | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|Pretrain | 0.745 | 1.533 | 0.723| 43.4 | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
|SOTA     | Yes   | Yes   | No   | Yes  | --- |ESOL  | ESOL| ESOL  | --- |ESOL  | --- |ESOL  | --- |
<br />
